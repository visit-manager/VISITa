...
CC = icc
LIB = -lm
OBJS = allocation.o assimilation.o atm_co2.o bioburn.o biome.o cal_cruclim.o cal_gcmclim2.o cal_stable.o canopy.o ch4emit.o ch4ox.o clear.o clim_cru.o clim_gcm.o clim_ncep.o clim_series.o cultpro.o doc.o ecophysiology.o erosion.o forestpro.o grasspro.o hydrology.o init_grid.o init_sim.o init_vs.o isotope.o landuse.o litterfall.o location.o main.o n_gasflux.o n_fertilizer.o n_budget.o open_input.o output_file.o output_glsum.o output_screen.o parameter_olson.o parameter_sage.o phenology.o phytgeo_c34.o radiation.o respiration.o soilpro.o vegetdeal.o vocemit.o npp_empirical.o parameter_crop.o
...
clim_ncep.o: structure.h prototype.h setting.h
...
n_gasflux.o: structure.h prototype.h setting.h
n_fertilizer.o: structure.h prototype.h setting.h
n_budget.o: structure.h prototype.h setting.h
...
output_glsum.o: structure.h prototype.h setting.h
