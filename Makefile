...
CC = cc
LIB = -lm
OBJS = allocation.o assimilation.o atm_co2.o bioburn.o biome.o cal_cruclim.o cal_gcmclim2.o cal_stable.o ch4emit.o ch4ox.o clear.o clim_cru.o clim_gcm.o clim_series.o cultpro.o doc.o ecophysiology.o erosion.o forestpro.o grasspro.o hydrology.o init.o init_vs.o isotope.o landuse.o litterfall.o location.o main.o n2oemit.o n_fertilizer.o n_flux.o open_input.o output_file.o output_screen.o parameter.o parameter_sage.o phenology.o phytgeo_c34.o radiation.o respiration.o soilpro.o vegetdeal.o vocemit.o
...
init.o: structure.h prototype.h setting.h
...
main.o: structure.h prototype.h setting.h
...
parameter.o: structure.h prototype.h setting.h
