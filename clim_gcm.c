...
void read_gcm_clim(
	...
	}else if(GCM==3900){  /*  GEOMIP: MPI-ESM-LR base (RCP4.5)  */
		if( (fp_t=fopen("./data/tas_CCSM4_197001-210012_rcp45_base.txt","rt"))==NULL ){  printf("No tas_CCSM4_197001-210012_rcp45_base.txt\n");  exit(1); }
		if( (fp_p=fopen("./data/pr_CCSM4_197001-210012_rcp45_base.txt","rt"))==NULL ){  printf("No pr_CCSM4_197001-210012_rcp45_base.txt\n");  exit(1); }
		if( (fp_h=fopen("./data/huss_CCSM4_197001-210012_rcp45_base.txt","rt"))==NULL ){  printf("No huss_CCSM4_197001-210012_rcp45_base.txt\n");  exit(1); }
		if( (fp_r=fopen("./data/rsds_CCSM4_197001-210012_rcp45_base.txt","rt"))==NULL ){  printf("No rsds_CCSM4_197001-210012_rcp45_base.txt\n");  exit(1); }
	}else if(GCM==3913){  /*  GEOMIP: MPI-ESM-LR G3  */
		if( (fp_t=fopen("./data/tas_CCSM4_197001-210012_rcp45_g3s.txt","rt"))==NULL ){  printf("No tas_CCSM4_197001-210012_rcp45_g3s.txt\n");  exit(1); }
		if( (fp_p=fopen("./data/pr_CCSM4_197001-210012_rcp45_g3s.txt","rt"))==NULL ){  printf("No pr_CCSM4_197001-210012_rcp45_g3s.txt\n");  exit(1); }
		if( (fp_h=fopen("./data/huss_CCSM4_197001-210012_rcp45_g3s.txt","rt"))==NULL ){  printf("No huss_CCSM4_197001-210012_rcp45_g3s.txt\n");  exit(1); }
		if( (fp_r=fopen("./data/rsds_CCSM4_197001-210012_rcp45_g3s.txt","rt"))==NULL ){  printf("No rsds_CCSM4_197001-210012_rcp45_g3s.txt\n");  exit(1); }
	}
