...
/*	printf("LA3: ");
	...
	printf("GPP: ");		ann=0.0;
	for(h=0;h<12;h++){		printf("%5.1lf ",(flux->plant).gpp[h]);		ann+=(flux->plant).gpp[h];	}		printf(" %.1lf\n",ann); 
	printf("NPP: ");		ann=0.0;
	for(h=0;h<12;h++){		printf("%5.1lf ",(flux->plant).npp[h]);		ann+=(flux->plant).npp[h];	}		printf(" %.1lf\n",ann); 
	printf("NEP: ");		ann=0.0;
